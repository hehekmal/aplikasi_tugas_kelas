...
class HikmalLoadingPage extends StatefulWidget {
  const HikmalLoadingPage({super.key});

  @override
  State<HikmalLoadingPage> createState() => _HikmalLoadingPageState();
}

class _HikmalLoadingPageState extends State<HikmalLoadingPage> {
  late Timer loadTime;
  late Timer loadbool;
  bool load = false;
  @override
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Image.asset('assets/images/whitebook.png', width: 150),
            SizedBox(height: 40),
            Container(
              height: 10,
